...
<div class="flex flex-col flex-1">
  ...
  <main class="h-full pb-16 overflow-y-auto">
    <div class="container px-6 mx-auto grid">
      ...
      <form id="form-submit" action="{{route('.admin.product.u')}}" method="POST" enctype="multipart/form-data">
        @csrf
        <div
        ...
        >
          <label class="block text-sm">
            ...
            <input
              class="product_name block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
          ...
          <label class="block text-sm">
            ...
            <input
              class="product_price block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
              placeholder="....."
              type="number"
              name = "price"
            />
          ...
          <label class="block text-sm">
            ...
            <input
              class="product_amount block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
              placeholder="....."
              type="number"
              name = "amount"
            />
          ...
          <label class="block text-sm">
            <span class="text-gray-700 dark:text-gray-400 ">Sale</span>
            <input
              class="product_sale block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
              placeholder="0%"
              type="number"
              name = "level"
            />
          ...
          <label class="block text-sm">
            ...
            <input
              class="product_image block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
              placeholder="0%"
              type="file"
              type="file" id="image" name="image"
            />
          </label>
          <div class=" block text-sm" id="add-stock" style="text-align: center;margin-top: 12px;">
            <button type="submit"
            id=""
    ...
    <h4
    class="mb-4 text-lg font-semibold text-gray-600 dark:text-gray-300 mt-16"
  >
    Table Products
  </h4>
  ...
  <div class="w-full overflow-hidden rounded-lg shadow-xs">
    ...
    >
      ...
      <span class="flex col-span-4 mt-2 sm:mt-auto sm:justify-end">
        {{$productpag->links('layout.partials.pagination-tailwind')}}
      </span>
